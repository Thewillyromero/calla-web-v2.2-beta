...
export const agents: Agent[] = [
  ...
  },
  {
    ...
    description: "BYTE analiza todas las conversaciones y te da métricas claras: cuántas llamadas se atienden, duración media, tasa de resolución, sentimiento del cliente y mucho más. Sabrás exactamente qué pasa con tu atención telefónica.",
    color: "brand-amber",
    hsl: "35 70% 58%",
    features: [
      "Panel de métricas en tiempo real accesible desde cualquier dispositivo",
      "Transcripción automática de cada llamada",
      "Análisis de sentimiento: sabe si el cliente está contento o frustrado",
      "Identifica patrones: horas pico, motivos de llamada más frecuentes, objeciones",
      "Informes semanales automáticos por email",
      "Grabación de llamadas para revisión y formación",
    ],
    howItWorks: [
