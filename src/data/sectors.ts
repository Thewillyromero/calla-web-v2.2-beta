...
export const sectors: Sector[] = [
  ...
  },
  {
    ...
    name: "Hostelería",
    icon: Utensils,
    tagline: "Reservas llenas y cero no-shows",
    description: "Gestión automatizada de reservas, confirmaciones y seguimiento para restaurantes, hoteles y espacios de eventos.",
    heroTitle: "Más reservas para tu",
    heroHighlight: "negocio de hostelería",
    painPoints: [
      "No-shows que dejan mesas vacías sin previo aviso",
      "Llamadas perdidas en horas punta que suponen ingresos perdidos",
      "Gestión manual de reservas que consume tiempo del equipo",
      "Dificultad para fidelizar clientes tras la primera visita",
    ],
    solutions: [
      "Agente de voz que atiende reservas 24/7 sin perder ninguna llamada",
      "Confirmaciones y recordatorios automáticos para eliminar no-shows",
      "Seguimiento post-visita para incentivar repetición y reseñas",
      "Gestión de listas de espera y cancelaciones en tiempo real",
    ],
    stats: [
      { value: "70%", label: "reducción de no-shows" },
      { value: "100%", label: "llamadas atendidas en hora punta" },
      { value: "2x", label: "más reservas recurrentes" },
    ],
    cta: "Quiero más reservas",
  },
  {
    slug: "logistica",
    name: "Logística",
    icon: Truck,
    tagline: "Incidencias resueltas sin colapsar el teléfono",
    description: "Automatización de consultas de seguimiento, incidencias y coordinación para empresas de transporte y logística.",
    heroTitle: "Más eficiencia para tu",
    heroHighlight: "empresa de logística",
    painPoints: [
      "Volumen masivo de llamadas de seguimiento que saturan el equipo",
      "Clientes sin respuesta inmediata ante incidencias o retrasos",
      "Coordinación manual entre conductores, almacén y cliente final",
      "Coste operativo elevado en atención al cliente",
    ],
    solutions: [
      "Agente de voz que resuelve consultas de seguimiento sin intervención humana",
      "Notificaciones proactivas ante retrasos o incidencias",
      "Escalado automático a operador humano solo cuando es necesario",
      "Registro y análisis de incidencias para mejorar procesos",
    ],
    stats: [
      { value: "80%", label: "consultas resueltas sin agente humano" },
      { value: "3 min", label: "tiempo medio de resolución" },
      { value: "40%", label: "reducción de coste en atención" },
    ],
    cta: "Quiero más eficiencia",
  },
  {
    slug: "rrhh",
    ...
    description: "Automatización de criba, citaciones y seguimiento de candidatos para departamentos de RRHH y consultoras de selección.",
    heroTitle: "Más agilidad para tu",
    heroHighlight: "proceso de selección",
    painPoints: [
      "Cientos de candidatos sin capacidad para llamar a todos",
      "Tiempo del equipo perdido en entrevistas con perfiles no válidos",
      "Candidatos que desaparecen entre el envío del CV y la entrevista",
      "Proceso de selección lento que hace perder talento frente a la competencia",
    ],
    solutions: [
      "Agente de voz que realiza la criba inicial con preguntas personalizadas",
      "Citación automática de candidatos cualificados directamente en agenda",
      "Recordatorios y confirmaciones para reducir ausencias a entrevistas",
      "Seguimiento post-entrevista y feedback automatizado",
    ],
    stats: [
      { value: "5x", label: "más candidatos procesados por semana" },
      { value: "60%", label: "reducción en tiempo de criba" },
      { value: "90%", label: "tasa de asistencia a entrevistas" },
    ],
    cta: "Quiero seleccionar mejor",
  },
  {
    slug: "energia",
    name: "Energía",
    icon: Zap,
    tagline: "Atención al cliente sin colapsos ni esperas",
    description: "Automatización de altas, bajas, incidencias y consultas para empresas de energía, agua y utilities.",
    heroTitle: "Más eficiencia para tu",
    heroHighlight: "empresa de energía",
    painPoints: [
      "Picos de llamadas en periodos de facturación que colapsan el servicio",
      "Clientes que esperan minutos para resolver consultas simples",
      "Coste elevado de centros de atención con alta rotación de personal",
      "Incidencias sin respuesta inmediata que generan reclamaciones",
    ],
    solutions: [
      "Agente de voz que gestiona altas, bajas y cambios de tarifa automáticamente",
      "Resolución inmediata de consultas de facturación sin esperas",
      "Notificaciones proactivas ante cortes o incidencias en la red",
      "Escalado a agente humano solo para casos complejos o reclamaciones",
    ],
    stats: [
      { value: "75%", label: "consultas resueltas sin intervención humana" },
      { value: "0 min", label: "tiempo de espera en consultas estándar" },
      { value: "50%", label: "reducción de reclamaciones formales" },
    ],
    cta: "Quiero mejorar la atención",
  },
  {
    slug: "turismo",
    name: "Turismo",
    icon: Plane,
    tagline: "Reservas y cambios gestionados en segundos",
    description: "Automatización de reservas, modificaciones, cancelaciones y soporte para agencias de viaje, hoteles y operadores turísticos.",
    heroTitle: "Más ventas para tu",
    heroHighlight: "agencia de viajes",
    painPoints: [
      "Picos de demanda en temporada alta que superan la capacidad del equipo",
      "Clientes que llaman fuera de horario y se pierden a la competencia",
      "Gestión manual de cambios y cancelaciones que consume horas",
      "Falta de seguimiento post-viaje para fidelizar al cliente",
    ],
    solutions: [
      "Agente de voz disponible 24/7 para consultas, reservas y modificaciones",
      "Gestión automática de cancelaciones y rebooking en tiempo real",
      "Seguimiento post-viaje para recoger valoraciones y generar repetición",
      "Campañas de retención para clientes de alto valor",
    ],
    stats: [
      { value: "24/7", label: "disponibilidad sin coste adicional" },
      { value: "35%", label: "más reservas fuera de horario laboral" },
      { value: "2x", label: "tasa de repetición de clientes" },
    ],
    cta: "Quiero más reservas",
  },
];
