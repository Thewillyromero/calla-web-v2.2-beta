              ...
              <div className="grid grid-cols-1 md:grid-cols-[5fr_4fr] gap-4 md:gap-5">
                ...
                <motion.div initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}
                  ...
                  <div className="p-5 md:p-6">
                    ...
                    <p className="text-base text-foreground/86 font-normal leading-relaxed">{capabilities[0].description}</p>
                  </div>
                ...
                <motion.div initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.1 }}
                  ...
                  <div className="p-5 md:p-6">
                    ...
                    <p className="text-base text-foreground/86 font-normal leading-relaxed">{capabilities[1].description}</p>
                  </div>
              ...
              <div>
                <motion.div initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.15 }}
                  ...
                  <div className="p-5 md:p-6">
                    ...
                    <p className="text-base text-foreground/86 font-normal leading-relaxed">{capabilities[3].description}</p>
                  </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5">
                ...
                <motion.div initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.2 }}
                  ...
                  <div className="p-5 md:p-6">
                    ...
                    <p className="text-base text-foreground/86 font-normal leading-relaxed">{capabilities[2].description}</p>
                  </div>
                ...
                <motion.div initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.25 }}
                  ...
                  <div className="p-5 md:p-6">
                    ...
                    <p className="text-base text-foreground/86 font-normal leading-relaxed">{capabilities[4].description}</p>
                  </div>
        ...
        <section className="py-16 md:py-24 px-5 md:px-6 relative overflow-hidden">
          <div className="container mx-auto relative z-10">
            ...
            >
              ...
              <p className="text-foreground/86 max-w-lg mx-auto text-base font-normal">
                Cuatro fases claras. Sin tecnicismos, sin sorpresas.
              </p>
            </motion.div>

            {/* Process pipeline — vertical cards */}
            <div className="relative max-w-4xl mx-auto">

              {/* Vertical track line */}
              <div className="hidden md:block absolute w-px overflow-hidden"
                style={{ left: "27px", top: "3.5rem", bottom: "3.5rem", background: "hsl(0 0% 100% / 0.08)", zIndex: 0 }}>
                <motion.div className="absolute w-full h-20"
                  style={{ background: "linear-gradient(180deg, transparent, hsl(0 0% 100% / 0.5), transparent)" }}
                  animate={{ y: ["-5rem", "calc(100% + 5rem)"] }}
              ...
              <div className="flex flex-col gap-4">
                {steps.map((step, i) => {
                  ...
                  return (
                    ...
                    >
                      {/* Timeline node */}
                      <div className="shrink-0 flex flex-col items-center pt-5 z-10">
                        <motion.div
                          className="w-14 h-14 rounded-full flex items-center justify-center font-mono font-black text-sm"
                          style={{ background: `hsl(${step.hsl} / 0.14)`, border: `2px solid hsl(${step.hsl} / 0.5)`, color: `hsl(${step.hsl})` }}
                          animate={{ boxShadow: [`0 0 0px hsl(${step.hsl} / 0)`, `0 0 14px hsl(${step.hsl} / 0.25)`, `0 0 0px hsl(${step.hsl} / 0)`] }}
                      ...
                      {/* Card */}
                      <div className="flex-1 rounded-2xl p-5 flex flex-col md:flex-row gap-5 md:gap-0"
                        style={{ background: "hsl(0 0% 100% / 0.03)", border: `1px solid hsl(${step.hsl} / 0.18)` }}>

                        {/* Text section */}
                        <div className="flex-1 flex flex-col justify-center md:pr-6">
                          <div className="flex items-center gap-2.5 mb-3">
                            <div className="w-7 h-7 rounded-lg flex items-center justify-center shrink-0"
                              style={{ background: `hsl(${step.hsl} / 0.15)` }}>
                              <StepIcon className="w-3.5 h-3.5" style={{ color: `hsl(${step.hsl})` }} />
                            </div>
                            <h3 className="font-display font-extrabold text-base text-foreground uppercase tracking-widest leading-tight">
                              {step.title}
                            </h3>
                          </div>
                          <p className="text-sm text-foreground/86 font-normal leading-relaxed mb-4">
                            {step.description}
                          </p>
                        ...
                        {/* Divider */}
                        <div className="hidden md:block w-px self-stretch" style={{ background: `hsl(${step.hsl} / 0.12)` }} />
          ...
          <div className="container mx-auto max-w-5xl relative z-10">
            <div className="bg-card/30 border border-border/20 rounded-3xl p-10 md:p-14 grid md:grid-cols-2 gap-10 md:gap-16 items-center">
              ...
              <motion.div {...fade}>
                ...
                <p className="text-foreground/86 text-base font-normal leading-relaxed mb-8">
